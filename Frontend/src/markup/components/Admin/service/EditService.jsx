...
const EditService = () => {
  ...
  const addServiceHandler = (e) => {
    ...
    // email validation
    if (!service_name) {
      setServiceNameErr("Update service name required");
      flag = false;
    } else {
      setServiceNameErr("");
    }
    ...
    if (!service_description) {
      setServiceDescErr("Update service description required");
      flag = false;
    } else {
      setServiceDescErr("");
    }
    ...
    const updateService = serviceService.updateService(updateData);
    useEffect(() => {
      setLoading(true);
      updateService
        .then((res) => res.json())
